...
| `halfflower-proposal.pdf` | 기업제휴 제안서 A4 5페이지. 내용은 index.html과 동일하게 유지합니다 |
...
인쇄하면 됩니다. 제안서에는 페이지에 없는 내용을 넣지 않습니다 — 문구를
고칠 때는 index.html과 이 파일을 함께 고치세요. 한글은 Noto Sans KR 기준이며, 페이지마다 297mm에 맞춰
